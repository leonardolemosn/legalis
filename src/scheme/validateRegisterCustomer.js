...
const validacaoCadastrarCliente = Joi.object({
    ...
    people_type_id: Joi.string()
    .valid(
        '0ca08cfc-9133-4d2a-8f26-5acb16456caf',
        '2e0b424c-f70d-4ba4-a7c4-21fc6d621da9',
        '3de1a4d2-815f-4763-835c-b74afa94fc8c',
        '4f9d4c94-8a28-4cf3-8e36-ae2946ef1075',
        'f252eb4b-f09e-4498-99f8-b9c462c2c89f'
    )
    .when('profile_type_id', {
        is: 'b12c7a51-f992-4067-895f-17ea018c3b92',
        then: Joi.required(),
        otherwise: Joi.optional()
    })
    .messages({
        "string.empty": "O campo people_type_id é obrigatório!",
        "any.required": "O campo people_type_id é obrigatório!",
        "any.only": "O people_type_id fornecido não é válido!"
    }),
    ...
    parent_office_id: Joi.string().allow(null, '').optional().messages({
        "string.empty": "O identificador da matriz deve ser válido ou nulo!"
    })
});

module.exports = { validacaoCadastrarCliente };
